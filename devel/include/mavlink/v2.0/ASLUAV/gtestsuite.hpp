...
TEST(ASLUAV, HIL_EXTENDED)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ASLUAV::msg::HIL_EXTENDED packet_in{};
    packet_in.timestamp = 93372036854775807ULL;
    packet_in.var1 = 73.0;
    packet_in.var2 = 101.0;
    packet_in.var3 = 129.0;
    packet_in.var4 = 157.0;
    packet_in.var5 = 185.0;
    packet_in.var6 = 213.0;
    packet_in.var7 = 241.0;
    packet_in.var8 = 269.0;

    mavlink::ASLUAV::msg::HIL_EXTENDED packet1{};
    mavlink::ASLUAV::msg::HIL_EXTENDED packet2{};
    ...
    EXPECT_EQ(packet1.timestamp, packet2.timestamp);
    EXPECT_EQ(packet1.var1, packet2.var1);
    EXPECT_EQ(packet1.var2, packet2.var2);
    EXPECT_EQ(packet1.var3, packet2.var3);
    EXPECT_EQ(packet1.var4, packet2.var4);
    EXPECT_EQ(packet1.var5, packet2.var5);
    EXPECT_EQ(packet1.var6, packet2.var6);
    EXPECT_EQ(packet1.var7, packet2.var7);
    EXPECT_EQ(packet1.var8, packet2.var8);
}

#ifdef TEST_INTEROP
TEST(ASLUAV_interop, HIL_EXTENDED)
{
    mavlink_message_t msg;
    ...
    mavlink_hil_extended_t packet_c {
    ...
    mavlink_msg_hil_extended_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.timestamp, packet2.timestamp);
    EXPECT_EQ(packet_in.var1, packet2.var1);
    EXPECT_EQ(packet_in.var2, packet2.var2);
    EXPECT_EQ(packet_in.var3, packet2.var3);
    EXPECT_EQ(packet_in.var4, packet2.var4);
    EXPECT_EQ(packet_in.var5, packet2.var5);
    EXPECT_EQ(packet_in.var6, packet2.var6);
    EXPECT_EQ(packet_in.var7, packet2.var7);
    EXPECT_EQ(packet_in.var8, packet2.var8);
