...
void protobuf_AddDesc_Imu_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "proto\032\016vector3d.proto\032\014Header.proto\"\303\002\n\003"
    ...
    "eration_covariance\030\007 \003(\002B\002\020\001\022\013\n\003seq\030\010 \002("
    "\003", 401);
...
// @@protoc_insertion_point(message_byte_size_start:gz_sensor_msgs.Imu)
  ...
  if (((_has_bits_[0] & 0x000000ab) ^ 0x000000ab) == 0) {  // All required fields are present.
    // required .gz_std_msgs.Header header = 1;
    total_size += 1 +
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        *this->header_);
...
bool Imu::IsInitialized() const {
  if ((_has_bits_[0] & 0x000000ab) != 0x000000ab) return false;
