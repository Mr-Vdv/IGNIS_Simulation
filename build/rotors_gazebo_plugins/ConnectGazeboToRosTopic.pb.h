...
enum ConnectGazeboToRosTopic_MsgType {
  ...
  ConnectGazeboToRosTopic_MsgType_VIS_VECTOR = 15,
  ConnectGazeboToRosTopic_MsgType_VIS_VECTOR_ARRAY = 16
};
...
const ConnectGazeboToRosTopic_MsgType ConnectGazeboToRosTopic_MsgType_MsgType_MAX = ConnectGazeboToRosTopic_MsgType_VIS_VECTOR_ARRAY;
...
class ConnectGazeboToRosTopic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gz_std_msgs.ConnectGazeboToRosTopic) */ {
 public:
  ...
  static const MsgType VIS_VECTOR =
    ConnectGazeboToRosTopic_MsgType_VIS_VECTOR;
  static const MsgType VIS_VECTOR_ARRAY =
    ConnectGazeboToRosTopic_MsgType_VIS_VECTOR_ARRAY;
